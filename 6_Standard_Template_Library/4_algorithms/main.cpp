...
int main()
{
	...
	auto iterator_maximum = std::max_element(daten.begin(), daten.end());
	std::cout << "Maximum betraegt: " << *iterator_maximum << std::endl;
	...
	auto iterator_first_odd = std::find_if(daten.begin(), daten.end(), IsOdd);
	std::cout << "Erste ungerade: " << *iterator_first_odd << std::endl;
